...
public class OrderController {
    ...
    public ResponseEntity<ResponseCartDTO> getbyusername(@Valid @RequestBody RequestGetOrderByusernameDTO getOrderByusernameDTO) {
        ResponseCartDTO getbyusername = orderService.getbyusername(getOrderByusernameDTO);
        return new ResponseEntity<>(getbyusername, HttpStatus.OK);
    }
